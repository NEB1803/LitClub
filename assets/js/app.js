...
<a class="navbar-brand" href="index.html">Lit Club</a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://www.psglitclub.com/">Home</a></li>
   <li class="nav-item">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >A reader lives a thousand lives before he dies . . . The man who never reads lives only one.\n                 -George R.R. Martin</p>
    </div>
    ...
    <a class="social-button instagram" href="https://www.instagram.com/litclubpsgimsr/" target="_blank" >
